...
LOCAL_WF = os.path.join(N8N_DIR, "workflows", "marketvoice_review_triage.json")
LEGACY_WF = os.path.join(PROJECT_ROOT, "workflows", "n8n", "workflows", "marketvoice_review_triage.json")
WORKFLOW_PATH = LOCAL_WF if os.path.exists(LOCAL_WF) else LEGACY_WF
